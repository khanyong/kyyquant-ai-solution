"""
키움 OpenAPI → Supabase 데이터 흐름 완전 테스트
각 테이블에 실제 데이터를 저장하고 관계를 확인
"""
    ...
    def test_2_technical_indicators(self):
        ...
        for stock in self.test_stocks:
            ...
            try:
                ...
                print(f"  볼린저밴드: {indicators['bb_lower']:.0f} ~ {indicators['bb_upper']:.0f}")
