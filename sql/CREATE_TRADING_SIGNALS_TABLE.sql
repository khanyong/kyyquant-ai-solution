...
CREATE INDEX IF NOT EXISTS idx_trading_signals_processed ON trading_signals(processed) WHERE NOT processed;
...
GRANT EXECUTE ON FUNCTION cleanup_old_trading_signals TO authenticated, service_role;
